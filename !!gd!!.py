...
def getnumber(lvlname):
    ...
    for i in range(len(lines)):
        if lines[i].split(sep)[0] == lvlname:
            gindex = int(lines[i].split(sep)[1])
    return gindex
...
# save([2.32, 2.34, 3.07, 's', 3.25, 'h', 3.75, 4.26, 's', 4.81, 5.11, 5.17, 's', 5.38, 5.98, 6.7, 's', 8.1, 'h', 8.51, 9.22, 's', 
#          9.71, 10.29, 10.98, 's', 11.55, 's', 11.86, 12.26, 12.34, 13.21, 'h', 13.62, 14.4, 's', 15.3, 's', 15.72, 16.46, 17.13, 17.95,
#            'h', 18.59,19.2,20.33, 's', 20.88, 'h', 21.32, 21.39, 'h', 21.54, 's', 22.04,
#            's', 22.27,'s', 23.2,23.4,24.12, 24.64, 25.7, 's', 26.23, 'h', 27.3, 28.05, 29.31, 30.28, 31.3, 
...
#            45.28, 46.2, 46.9, 47.62, 48.1, 49.14, 's', 49.77, 50.88, 'h', 51.3, 51.6,
#             'h', 51.9, 52.1, 'h', 52.42, 'h', 53.0, 53.39, 's', 53.95, 54.44, 'h', 54.95, 's', 55.71, 56.26,
#         'h', 56.73, 'h', 57.88, 'h', 58.39,
#      's', 59.85, 's', 60.95, 's', 61.17, 61.45, 'h', 61.84, 'mh', 62.28, 'xh', 62.37, 'xh', 63.1, 'xh', 63.15, 'xh', 63.6], 'dry out')

# a1 = [2.32, 2.34, 3.07, 's', 3.25, 'h', 3.75, 4.26, 's', 4.81, 5.11, 5.17, 's', 5.38, 5.98, 6.7, 's', 8.1, 'h', 8.51, 9.22, 's', 
#          9.71, 10.29, 10.98, 's', 11.55, 's', 11.86, 12.26, 12.34, 13.21, 'h', 13.62, 14.4, 's', 15.3, 's', 15.72, 16.46, 17.13, 17.95,
#            'h', 18.59,19.2,20.33, 's', 20.88, 'h', 21.32, 21.39, 'h', 21.54, 's', 22.04,
#            's', 22.27,'s', 23.2,23.4,24.12, 24.64, 25.7, 's', 26.23, 'h', 27.3, 28.05, 29.31, 30.28, 31.3, 
#            31.89, 32.51, 's', 33.34, 33.73, 34.48, 'h', 35.15, 35.77, 'h', 36.66, 36.97, 's', 37.32, 
...
#             'h', 51.9, 52.1, 'h', 52.42, 'h', 53.0, 53.39, 's', 53.95, 54.44, 'h', 54.95, 's', 55.71, 56.26,
#         'h', 56.73, 'h', 57.88, 'h', 58.39,
#      's', 59.85, 's', 60.95, 's', 61.17, 61.45, 'h', 61.84, 'mh', 62.28, 'xh', 62.37, 'xh', 63.1, 'xh', 63.15, 'xh', 63.6, 'lh', 64.21, 'xh', 64.6]

a2 =[2.32, 2.34, 3.07, 's', 3.25, 'h', 3.75, 4.26, 's', 4.81, 5.11, 5.17, 's', 5.38, 5.98, 6.7, 's', 8.1, 'h', 8.51, 9.22, 's', 
          9.71, 10.29, 10.98, 's', 11.55, 's', 11.86, 12.26, 12.34, 13.21, 'h', 13.62, 14.4, 's', 15.3, 's', 15.72, 16.46, 17.13, 17.95,
            'h', 18.59,19.2,20.33, 's', 20.88, 'h', 21.32, 21.39, 'h', 21.54, 's', 22.04,
            's', 22.27,'s', 23.2,23.4,24.12, 24.64, 25.7, 's', 26.23, 'h', 27.3, 28.05, 29.31, 30.28, 31.3, 
            31.89, 32.51, 's', 33.34, 33.73, 34.48, 'h', 35.15, 35.77, 'h', 36.66, 36.97, 's', 37.32, 
            ...
            45.28, 46.2, 46.9, 47.62, 48.1, 49.14, 's', 49.77, 50.88, 'h', 51.3, 51.6,
             'h', 51.9, 52.1, 'h', 52.42, 'h', 53.0, 53.39, 's', 53.95, 54.44, 'h', 54.95, 's', 55.71, 56.26,
         'h', 56.73, 'h', 57.88, 'h', 58.39,
      's', 59.85, 's', 60.95, 's', 61.17, 61.45, 'h', 61.84, 'mh', 62.28, 'xh', 62.37, 'xh', 63.1, 'xh', 63.15, 'xh', 63.7,'lh', 64.21, 'xh', 64.52]

#save(a2,'dry out')
# s1 = execute(a1)
# print(s1,'= s1')
# print(s2,'=s2')
# print(isfirstargbetter(s1, a1, s2, a2))
